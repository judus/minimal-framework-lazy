...
require __DIR__ . "/minimal/vendor/autoload.php";

App::respond([
    'basepath' => __DIR__,
    'config' => __DIR__ . '/minimal/config/environment.php',
    'providers' => __DIR__ . '/minimal/config/providers.php',
    'bindings' => __DIR__ . '/minimal/config/bindings.php',
    'modules' => __DIR__ . '/minimal/config/modules.php',
    'minimal' => __DIR__ . '/minimal/config/minimal.php'
],function () {
